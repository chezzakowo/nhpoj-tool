...
Mở trình duyệt lên và nó sẽ tự động điểm danh hộ cho bạn
...
```bash
https://github.com/chezzakowo/nhpoj-tool.git
```

hoặc tải file ZIP từ [Releases](https://github.com/chezzakowo/nhpoj-tool/releases) rồi giải nén.
